...
func TestMapOfAny_GroupHeader(t *testing.T) {

	values := test_mapOfAny_GroupValues()
...
func TestMapOfAny_GroupFooter(t *testing.T) {
...
func test_mapOfAny_GroupValues() MapOfAny {
