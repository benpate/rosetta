...
func TestAny_GroupFooter_FirstElementClosesItsGroup(t *testing.T) {

	// A single element is both the header AND the footer of its group
	single := Any{mapof.String{"group": "a"}}.GroupBy("group")
	...
	pair := Any{mapof.String{"group": "a"}, mapof.String{"group": "b"}}.GroupBy("group")
