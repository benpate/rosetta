...
func (t *testStructB) GetObjectOK(path string) (any, bool) {
	if path == "array" {
		return &t.Array, true
	}
	return nil, false
...
func (t *testStructB) SetInt64OK(path string, value int64) bool {
	if path == "published" {
		t.Published = value
		return true
	}
...
func (t *testStructB) SetStringOK(path string, value string) bool {
	if path == "name" {
		t.Name = value
		return true
	}
